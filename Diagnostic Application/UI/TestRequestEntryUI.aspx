<%@ Page Language="C#" Title="Test Request Entry" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="TestRequestEntryUI.aspx.cs" Inherits="Diagnostic_Application.UI.TestRequestEntryUI" %>
    ...
    <form id="form1" class="form-horizontal" runat="server">
        ...
        <div class="col-lg-9">
            ...
            <div class="type-setup">
                ...
                <td><input type="text" id="DateOfBirthTextBox" /></td>
            </tr>--%>
        ...
        $(document).ready(function () {
            ...
            $("#ourForm").validate({
                ...
                messages: {
                    ...
                    email: {
                        required: "Must be given your Email ID",
                        email: "it needs to be abc@def.ch"
                    },
                    password: {
                        required: "Must be given",
                        maxlength: "Must be below 8 characters"
                    },
                    confirmPassword: {
                        required: "Must be given",
                        maxlength: "Must be below 8 characters",
                        equalTo: "Did not match with above Password"
                    }
                }
            });
        });
