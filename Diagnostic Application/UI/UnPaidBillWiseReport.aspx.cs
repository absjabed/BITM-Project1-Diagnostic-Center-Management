...
namespace Diagnostic_Application.UI {
    public partial class UnPaidBillWiseReport : System.Web.UI.Page {
        ...
        protected void PdfButton_Click(object sender, EventArgs e) {
            ...
            pdfDocument.Add(new Paragraph(" \n\n"));
            pdfDocument.Add(new Paragraph("                                          " + "Unpaid Bill Report between date: " + start + " and " + end));
            pdfDocument.Add(new Paragraph(" \n"));
            pdfDocument.Add(pdfTable);
            pdfDocument.Close();
            Response.ContentType = "application/pdf";
            Response.AppendHeader("content-disposition", "attachment;filename=Unpaid_Bill_Report(" + start + "_to_" + end + ").pdf");
